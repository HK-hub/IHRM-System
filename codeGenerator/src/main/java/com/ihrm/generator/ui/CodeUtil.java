...
//												.addComponent(jTextField4)
	...
	private void formWindowOpened(java.awt.event.WindowEvent evt) {
		...
		String realPath = substring.substring(0, substring.lastIndexOf("\\"));
		File directory = new File(realPath + "\\templates");//设定为当前文件夹
		this.basePathName = realPath ;
		...
		if (listFiles != null) {
			for (File f : listFiles) {
				if (f.isDirectory()) {
					System.out.println("模板路径："+f.getPath());
			  ...
			  public void run(){
				  try{
					//路径map封装
						...
						//获取当前文件夹下的模板目录下的所有文件夹
					  String basePath =  basePathName + "\\templates\\"
							  + jComboBox1.getSelectedItem();//设定为当前文件夹

					  String basePath2 = new File("").getAbsolutePath() + "\\templates\\"
								+ jComboBox1.getSelectedItem();//设定为当前文件夹
...
//	}
	 ...
	 * @param db				数据库信息
	 */
	private void generator(String templatePath,String outpath,Settings settings,DataBase db) {
